/* eslint-disable prefer-rest-params, no-param-reassign, prefer-spread */
/**
 * This is chai-as-promise
 */
  ...
  originalAssertMethods.forEach((assertMethodName) => {
    assert.eventually[assertMethodName] = function (promise) {
      ...
      const returnedPromise = promise.then(
        (fulfillmentValue) =>
          assert[assertMethodName].apply(assert, [fulfillmentValue].concat(otherArgs)),
